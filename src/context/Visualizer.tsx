...
interface SortingAlgorithmContextType {
  ...
  setIsAnimationComplete: (status: boolean) => void;
...
export const SortingAlgorithmProvider = ({
  ...
  const runAnimation = (animations: AnimationArrayType) => {
    ...
    const updateHeightValue = (
      ...
      const lineElement = arrayLines[lineIndex] as HTMLElement;
...
export const useSortingAlgorithmContext = () => {
  ...
  if (!context) {
    throw new Error(
      "UseSortingAlgorithmContext must be used within a Sorting Algorithm Provider"
    );
  }
  return context;
};
